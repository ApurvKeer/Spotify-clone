    ...
    final genres = [
      {
        'id': 'rock',
        'name': 'Rock',
        'coverUrl': 'https://via.placeholder.com/400x400?text=Rock',
        'order': 1,
      },
      {
        'id': 'pop',
        'name': 'Pop',
        'coverUrl': 'https://via.placeholder.com/400x400?text=Pop',
        'order': 2,
      },
      {
        'id': 'jazz',
        'name': 'Jazz',
        'coverUrl': 'https://via.placeholder.com/400x400?text=Jazz',
        'order': 3,
      },
      {
        'id': 'classical',
        'name': 'Classical',
        'coverUrl': 'https://via.placeholder.com/400x400?text=Classical',
        'order': 4,
      },
    ];
    ...
    final songs = [
      {
        ...
        'genre': 'Rock',
        'genreId': 'rock',
        'coverUrl': 'https://via.placeholder.com/300x300?text=Midnight+Dreams',
        'duration': 240,
        'is_active': true,
      ...
      },
      {
        ...
        'genre': 'Pop',
        'genreId': 'pop',
        'coverUrl': 'https://via.placeholder.com/300x300?text=Electric+Vibes',
        'duration': 200,
        'is_active': true,
      ...
      },
      {
        ...
        'genre': 'Jazz',
        'genreId': 'jazz',
        'coverUrl': 'https://via.placeholder.com/300x300?text=Smooth+Jazz',
        'duration': 320,
        'is_active': true,
      ...
      },
      {
        ...
        'genre': 'Classical',
        'genreId': 'classical',
        'coverUrl': 'https://via.placeholder.com/300x300?text=Symphony',
        'duration': 600,
        'is_active': true,
      ...
      },
      {
        ...
        'genre': 'Pop',
        'genreId': 'pop',
        'coverUrl': 'https://via.placeholder.com/300x300?text=Summer+Nights',
        'duration': 210,
        'is_active': true,
      ...
      },
      {
        ...
        'genre': 'Rock',
        'genreId': 'rock',
        'coverUrl': 'https://via.placeholder.com/300x300?text=Hard+Rock',
        'duration': 280,
        'is_active': true,
